...
//#endif
...
#ifdef ENVELOPE
		SFINISH_SNCAT(&client_auth->int_conn_length, client_auth->str_connname, (size_t)0, "");
#else
...
#ifdef ENVELOPE
		SFINISH_SNCAT(str_cookie_name, "envelope", (size_t)8);
#else
		...
		*ptr_conn_end = 0;
		...
		size_t int_temp = 0;
		SFINISH_SNCAT(str_response, &int_temp, str_temp, strlen(str_temp));
