...
function zoomGet() {
    ...
    return parseInt(localStorage['pgmanageZoom' + zoomGetPageName()], 10);
}
...
function zoomLoadCookie() {
    ...
    // we only want to set the body's font-size if the pgmanage zoom has been set
...
function zoomSet(newValue) {
    ...
    localStorage['pgmanageZoom' + zoomGetPageName()] = intValue;
