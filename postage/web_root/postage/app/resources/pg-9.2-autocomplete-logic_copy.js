...
function autocompleteChangeHandler(tabElement, editor, event) {
    ...
    var strScript, intCursorPosition, currentQueryRange, i, len
      ...
      , bolPreviousCharReturn, bolCurrentCharReturn, bolIsPeriod
        ...
        if (strPreviousWord) {
            ...
            // query specific autocomplete
                ...
                // PREPARE TRANSACTION/COMMIT PREPARED/ROLLBACK PREPARED
                    ...
                    if (strPreviousKeyWord === 'ALTER' && bolIsPeriod && strPreviousKeyWord === strPreviousWord) {
                ...
                // ALTER AGGREGATE and ALTER COLLATION and ALTER CONVERSION
                    ...
                    if (strPreviousWord === 'TRIGGER' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (strPreviousWord === 'EXTENSION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.extension];
                        
                    } else if (strPreviousKeyWord === 'EXTENSION' && bolIsPeriod) {
                        arrQueries = [['UPDATE', 'UPDATE TO', 'SET SCHEMA', 'ADD', 'DROP']];
                        
                    } else if ((/(ADD|DROP)/gi).test(strPreviousKeyWord) && bolIsPeriod) {
                    ...
                    if (strPreviousWord === 'WRAPPER' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.extension];
                        
                    } else if (arrPreviousWords[1] === 'WRAPPER' && bolIsPeriod) {
                    ...
                    if (strPreviousWord === 'TABLE' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'ONLY' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if (strPreviousWord === 'TYPE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                        
                    } else if (strPreviousKeyWord === 'TYPE' && bolIsPeriod) {
                        arrQueries = [['COLLATE']];
                        
                    } else if (strPreviousWord === 'COLLATE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.collations];
                    ...
                    } else if (strPreviousWord === 'INHERIT' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (strPreviousWord === 'FUNCTION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousKeyWord === 'FUNCTION' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'SET' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.settings];
                        
                    } else if (strPreviousWord === 'RESET' && bolIsPeriod) {
                        arrQueries = [['ALL'], autocompleteQuery.settings];
                        
                    } else if (strPreviousKeyWord === 'SET' && bolIsPeriod) {
                        arrQueries = [['TO', 'TO DEFAULT', 'FROM CURRENT']];
                    ...
                    if (strPreviousWord === 'GROUP' && bolIsPeriod) {
                        arrQueries = [['CURRENT_USER', 'SESSION_USER'], autocompleteQuery.roles];
                        
                    } else if (arrPreviousWords[1] === 'GROUP' && bolIsPeriod) {
                        arrQueries = [['ADD USER', 'DROP USER', 'RENAME TO']];
                        
                    } else if ((strPreviousWord === 'USER' && bolIsPeriod) || bolAfterComma) {
                        arrQueries = [autocompleteQuery.roles];
                    }
                    
                } else if ((/^(ALTER\s*INDEX)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'INDEX' && bolIsPeriod) {
                        arrQueries = [['IF EXISTS', 'ALL IN TABLESPACE'], autocompleteQuery.schemas];
                        
                    } else if (strPreviousWord === 'EXISTS' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (strPreviousWord === 'LANGUAGE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.language];
                        
                    } else if (arrPreviousWords[1] === 'LANGUAGE' && bolIsPeriod) {
                        arrQueries = [['RENAME TO', 'OWNER TO']];
                    }
                    
                } else if ((/^(ALTER\s*LARGE\s*OBJECT)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'OBJECT' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.large_objects];
                        
                    } else if (arrPreviousWords[1] === 'OBJECT' && bolIsPeriod) {
                        arrQueries = [['OWNER TO']];
                    }
                    
                } else if ((/^(ALTER\s*MATERIALIZED\s*VIEW)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'VIEW' && bolIsPeriod) {
                        arrQueries = [['IF EXISTS', 'ALL IN TABLESPACE'], autocompleteQuery.schemas];
                        ...
                        arrQueries = [autocompleteQuery.schemas];
                            ...
                            && strPreviousWord !== strPreviousKeyWord && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'TABLESPACE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.tablespace];
                    ...
                    if (strPreviousWord === 'CLASS' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousKeyWord === 'CLASS' && bolIsPeriod) {
                        arrQueries = [['USING']];
                        
                    } else if (strPreviousWord === 'USING' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.access_methods];
                        
                    } else if (strPreviousKeyWord === 'USING' && bolIsPeriod) {
                        arrQueries = [['RENAME TO', 'OWNER TO', 'SET SCHEMA']];
                    }
                    
                } else if ((/^(ALTER\s*OPERATOR\s*FAMILY)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'FAMILY' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousKeyWord === 'FAMILY' && bolIsPeriod) {
                        arrQueries = [['USING']];
                    ...
                    } else if ((arrPreviousWords[2] + arrPreviousWords[1]) === 'ADDOPERATOR' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if ((arrPreviousWords[1] + arrPreviousWords[0]) === 'ORDERBY' && bolIsPeriod) {
                    ...
                    if (strPreviousWord === 'OPERATOR' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousWord[strPreviousWord.length - 1] === ')' && bolIsPeriod) {
                        arrQueries = [['OWNER TO', 'SET SCHEMA']];
                    }
                    
                } else if ((/^(ALTER\s*POLICY)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'POLICY' && bolIsPeriod) {
                        if (parseFloat(contextData.minorVersionNumber, 10) >= 9.5) {
                            arrQueries = [autocompleteQuery.policies];
                        }
                        
                    } else if (strPreviousKeyWord === 'POLICY' && bolIsPeriod) {
                        arrQueries = [['ON']];
                        
                    } else if (strPreviousWord === 'ON' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousKeyWord === 'ON' && bolIsPeriod) {
                        arrQueries = [['TO', 'USING', 'WITH CHECK']];
                        
                    } else if (strPreviousWord === 'TO' && bolIsPeriod) {
                        arrQueries = [['CURRENT_USER', 'PUBLIC', 'SESSION_USER'], autocompleteQuery.roles];
                        
                    } else if (arrPreviousWords[1] === 'TO' && bolIsPeriod) {
                    ...
                    if (strPreviousWord === 'ROLE' && bolIsPeriod) {
                        arrQueries = [['ALL', 'CURRENT_USER', 'SESSION_USER'], autocompleteQuery.roles];
                        
                    } else if (arrPreviousWords[1] === 'ROLE' && bolIsPeriod) {
                        arrQueries = [['RENAME TO', 'WITH', 'IN DATABASE', 'SET', 'RESET']];
                        
                    } else if (strPreviousWord === 'DATABASE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.databases];
                        
                    } else if (arrPreviousWords[1] === 'DATABASE' && bolIsPeriod) {
                        arrQueries = [['SET', 'RESET']];
                        
                    } else if (strPreviousWord === 'SET' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.settings];
                        
                    } else if (strPreviousWord === 'WITH' && bolIsPeriod) {
                    ...
                    } else if (arrPreviousWords[1] === 'SET' && bolIsPeriod) {
                        arrQueries = [['TO', 'TO DEFAULT', 'FROM CURRENT']];
                    ...
                    if (strPreviousWord === 'RULE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.rules];
                        
                    } else if (arrPreviousWords[1] === 'RULE' && bolIsPeriod) {
                        arrQueries = [['ON']];
                        
                    } else if (strPreviousWord === 'ON' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'ON' && bolIsPeriod) {
                        arrQueries = [['RENAME TO']];
                    }
                    
                } else if ((/^(ALTER\s*SCHEMA)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'SCHEMA' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'SCHEMA' && bolIsPeriod) {
                        arrQueries = [['OWNER TO', 'RENAME TO']];
                    }
                    
                } else if ((/^(ALTER\s*SEQUENCE)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'SEQUENCE' && bolIsPeriod) {
                        arrQueries = [['IF EXISTS'], autocompleteQuery.schemas];
                        
                    } else if (strPreviousWord === 'EXISTS' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if ((/(SEQUENCE|EXISTS)/gi).test(arrPreviousWords[1]) && bolIsPeriod) {
                    ...
                    } else if ((arrPreviousWords[1] + arrPreviousWords[0]) === 'OWNEDBY' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    }
                    
                } else if ((/^(ALTER\s*SERVER)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'SERVER' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.servers];
                        
                    } else if (strPreviousKeyWord === 'SERVER' && bolIsPeriod) {
                        arrQueries = [['VERSION', 'OPTIONS', 'OWNER TO', 'RENAME TO']];
                        
                    } else if (strPreviousKeyWord === 'VERSION' && bolIsPeriod) {
                        arrQueries = [['OPTIONS']];
                    ...
                    if (strPreviousWord === 'SYSTEM' && bolIsPeriod) {
                        arrQueries = [['SET', 'RESET']];
                    ...
                    if (strPreviousWord === 'TABLESPACE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.tablespace];
                        
                    } else if (arrPreviousWords[1] === 'TABLESPACE' && bolIsPeriod) {
                    ...
                    } else if (strPreviousKeyWord === 'COLLATE' && bolIsPeriod) {
                        arrQueries = [['USING']];
                    ...
                    } else if (strPreviousWord === 'DEFERRABLE' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'ADD' && bolIsPeriod) {
                        arrQueries = [['CONSTRAINT', 'UNIQUE USING INDEX', 'PRIMARY KEY USING INDEX']];
                        
                    } else if (strPreviousWord === 'INDEX' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousKeyWord === 'INDEX' && bolIsPeriod) {
                        arrQueries = [['DEFERRABLE', 'NOT DEFERRABLE', 'INITIALLY DEFERRED', 'INITIALLY IMMEDIATE']];
                    ...
                    } else if (strPreviousWord === 'OF' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                    ...
                    if (strPreviousWord === 'CONFIGURATION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'CONFIGURATION' && bolIsPeriod) {
                    ...
                    } else if (arrPreviousWords[1] === 'REPLACE' && bolIsPeriod) {
                        arrQueries = [['WITH']];
                        
                    } else if (strPreviousWord === 'FOR' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.text_search_tokens];
                        
                    } else if (strPreviousWord === 'REPLACE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if (arrPreviousWords[1] === 'TRIGGER' && bolIsPeriod) {
                        arrQueries = [['ON']];
                    ...
                    if (strPreviousWord === 'TYPE' && bolIsPeriod
                                                        && !autocompleteSearchBackForWord(strScript, intCursorPosition, 'ATTRIBUTE')) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'TYPE' && bolIsPeriod
                                                        && !autocompleteSearchBackForWord(strScript, intCursorPosition, 'ATTRIBUTE')) {
                    ...
                    } else if (arrPreviousWords[1] === 'COLLATE' && bolIsPeriod) {
                        arrQueries = [['CASCADE', 'RESTRICT']];
                    ...
                    } else if (arrPreviousWords[1] === 'FOR' && bolIsPeriod) {
                        arrQueries = [['SERVER']];
                        
                    } else if (strPreviousWord === 'SERVER' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.servers];
                        
                    } else if (arrPreviousWords[1] === 'SERVER' && bolIsPeriod) {
                        arrQueries = [['OPTIONS']];
                    ...
                    if (strPreviousWord === 'USER' && bolIsPeriod) {
                        if (parseFloat(contextData.minorVersionNumber, 10) >= 9.5) {
                            arrQueries = [['CURRENT_USER', 'SESSION_USER'], autocompleteQuery.roles];
                        } else {
                            arrQueries = [autocompleteQuery.roles];
                    ...
                    } else if (arrPreviousWords[1] === 'USER' && bolIsPeriod) {
                    ...
                    if (strPreviousKeyWord === 'CREATE' && bolIsPeriod && strPreviousKeyWord === strPreviousWord) {
                    ...
                    if (strPreviousWord === 'AGGREGATE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (intCloseParen === 0 && ((strPreviousWord === 'AS' && bolIsPeriod) || bolCurrentCharOpenParen)) {
                        arrQueries = [autocompleteQuery.types];
                        
                    } else if (!autocompleteSearchBackForWord(strScript, intCursorPosition, 'FUNCTION') && bolIsPeriod && intCloseParen === 1) {
                        arrQueries = [['WITH FUNCTION', 'WITHOUT FUNCTION', 'WITH INOUT']];
                        
                    } else if ((arrPreviousWords[1] + strPreviousWord) === 'WITHFUNCTION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                                ...
                                ) && !(/ASSIGNMENT|IMPLICIT/gi).test(strPreviousWord) && bolIsPeriod) {
                        arrQueries = [['AS ASSIGNMENT', 'AS IMPLICIT']];
                    }
                    
                } else if ((/^(CREATE\s*COLLATION)/gi).test(strSearchQuery)) {
                    if (strPreviousWord === 'COLLATION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (strPreviousWord === 'CONVERSION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'CONVERSION' && bolIsPeriod) {
                        arrQueries = [['FOR']];
                        
                    } else if ((strPreviousWord === 'FOR' || strPreviousWord === 'TO') && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'FROM' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (arrPreviousWords[1] === 'DATABASE' && bolIsPeriod) {
                        arrQueries = [['WITH']];
                        
                    } else if ((strPreviousWord === 'WITH' && bolIsPeriod && !bolCurrentCharReturn)
                            || (strCurrentLine === '  ' || strCurrentLine === '    ' || strCurrentLine === '\t' || strCurrentLine.trim() === ',')) {
                    ...
                    if (arrPreviousWords[1] === 'DOMAIN' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [['AS']];
                        
                    } else if ((strPreviousWord === 'AS' && bolIsPeriod && !bolCurrentCharReturn)) {
                        arrQueries = [autocompleteQuery.types];
                        
                    } else if (arrPreviousWords[1] === 'AS' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [['COLLATE', 'DEFAULT']];
                        
                    } else if (strPreviousWord === 'COLLATE' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [autocompleteQuery.collates];
                        
                    } else if ((strCurrentLine === '  ' || strCurrentLine === '    ' || strCurrentLine === '\t' || strCurrentLine.trim() === ',')) {
                        arrQueries = [['CONSTRAINT', 'NOT NULL', 'NULL', 'CHECK']];
                        
                    } else if (strPreviousWord === 'CONSTRAINT' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [autocompleteQuery.constraints];
                        
                    } else if (arrPreviousWords[1] === 'CONSTRAINT' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [['NOT NULL', 'NULL', 'CHECK']];
                    }
                    
                } else if ((/^(CREATE\s*EVENT\s*TRIGGER)/gi).test(strSearchQuery)) {
                    if (intVersion >= 9.3) {
                        if (arrPreviousWords[1] === 'TRIGGER' && bolIsPeriod && !bolCurrentCharReturn) {
                            arrQueries = [['ON']];
                            
                        } else if ((strPreviousWord === 'ON' && bolIsPeriod && !bolCurrentCharReturn)) {
                            arrQueries = [['ddl_command_start', 'ddl_command_end', 'table_rewrite', 'sql_drop']];
                            
                        } else if (arrPreviousWords[1] === 'ON' && bolIsPeriod && !bolCurrentCharReturn) {
                            arrQueries = [['WHEN TAG IN', 'EXECUTE PROCEDURE']];
                            
                        } else if ((strPreviousWord === 'PROCEDURE' && bolIsPeriod && !bolCurrentCharReturn)) {
                            arrQueries = [autocompleteQuery.schemas];
                    ...
                    if ((strPreviousWord === 'EXTENSION' && bolIsPeriod && !bolCurrentCharReturn)) {
                        arrQueries = [['IF NOT EXISTS']];
                        
                    } else if ((/(EXISTS|EXTENSION)/gi).test(arrPreviousWords[1]) && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [['WITH']];
                        
                    } else if ((strPreviousWord === 'SCHEMA' && bolIsPeriod && !bolCurrentCharReturn)) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if (arrPreviousWords[1] !== 'NO' && strPreviousWord === 'HANDLER' && bolIsPeriod && !bolCurrentCharReturn) {
                        arrQueries = [['NO HANDLER'], autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] !== 'NO' && strPreviousWord === 'VALIDATOR' && bolIsPeriod && !bolCurrentCharReturn) {
                    ...
                    } else if (intParenLevel === 1 && strCurrentLine.trim() === strPreviousWord && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                        
                    } else if (intParenLevel === 1 && strCurrentLine.trim() === '') {
                        arrQueries = [['CONSTRAINT', 'CHECK']];
                        
                    } else if (autocompleteGlobals.arrTypes.indexOf(strPreviousWord.toLowerCase()) !== -1 && bolIsPeriod) {
                        arrQueries = [['OPTIONS', 'COLLATE', 'CONSTRAINT', 'NOT NULL', 'NULL', 'CHECK', 'DEFAULT']];
                        
                    } else if (arrPreviousWords[1] === 'CONSTRAINT' && bolIsPeriod) {
                        arrQueries = [['NOT NULL', 'NULL', 'CHECK', 'DEFAULT']];
                        
                    } else if (strPreviousWord === 'COLLATE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.collates];
                        
                    } else if (intParenLevel === 0 && strPreviousWord[strPreviousWord.length - 1] === ')' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'RETURNS' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'LANGUAGE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.language];
                    ...
                    if (arrPreviousWords[1] === 'GROUP' && !autocompleteSearchBackForWord(strScript, intCursorPosition, 'WITH') && bolIsPeriod) {
                        arrQueries = [['WITH']];
                    ...
                    if (strPreviousWord === 'ON' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    if (strPreviousWord === 'HANDLER' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    } else if (strPreviousWord === 'INLINE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    } else if (strPreviousWord === 'VALIDATOR' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if (arrPreviousWords[1] === 'CLASS' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'FAMILY' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousWord === 'STORAGE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                        
                    } else if (arrPreviousWords[1] === 'OPERATOR' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (strPreviousWord[1] === 'BY' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.btree_operator_families];
                        
                    } else if ((strCurrentLine === '  ' || strCurrentLine === '    ' || strCurrentLine === '\t' ||
                                (strCurrentLine.trim() === ',' && bolIsPeriod))) {
                    ...
                    } else if (arrPreviousWords[1] === 'FAMILY' && bolIsPeriod) {
                        arrQueries = [['USING']];
                    ...
                    if (intVersion >= 9.5) {
                        ...
                        } else if (arrPreviousWords[1] === 'POLICY' && bolIsPeriod) {
                            arrQueries = [['ON']];
                    ...
                    if (arrPreviousWords[1] === 'ROLE' && !autocompleteSearchBackForWord(strScript, intCursorPosition, 'WITH') && bolIsPeriod) {
                        arrQueries = [['WITH']];
                    } else if (((/^(ROLE|GROUP|ADMIN|USER)$/gi).test(strPreviousWord) || bolAfterComma)
                    ...
                    if (arrPreviousWords[1] === 'RULE' && bolIsPeriod) {
                        arrQueries = [['AS ON']];
                    ...
                    } else if (strPreviousWord === 'DO' && bolIsPeriod) {
                        arrQueries = [['ALSO', 'INSTEAD', 'NOTHING', 'SELECT', 'INSERT', 'UPDATE', 'DELETE', 'NOTIFY']];
                        
                    } else if ((/(ALSO|INSTEAD)/).test(strPreviousWord) && bolIsPeriod) {
                    ...
                    } else if ((arrPreviousWords[1] === 'SCHEMA' || arrPreviousWords[1] === 'EXISTS') && bolIsPeriod) {
                        arrQueries = [['AUTHORIZATION']];
                        
                    } else if (strPreviousWord === 'AUTHORIZATION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.roles];
                    }
                    ...
                    } else if ((arrPreviousWords[1] + strPreviousWord) === 'OWNEDBY' && bolIsPeriod) {
                    ...
                    if (arrPreviousWords[1] === 'SERVER'
                                && (
                                        (bolIsPeriod && !bolCurrentCharReturn)
                                     || (strCurrentLine === '  ' || strCurrentLine === '    ' || strCurrentLine === '\t')
                                    )) {
                    ...
                    } else if (strPreviousWord === 'WRAPPER' && bolIsPeriod) {
                    ...
                    if (arrPreviousWords[1] === 'TABLESPACE' && bolIsPeriod) {
                        arrQueries = [['OWNER', 'LOCATION', 'WITH']];
                        
                    } else if (arrPreviousWords[1] === 'OWNER' && bolIsPeriod) {
                        arrQueries = [['LOCATION', 'WITH']];
                        
                    } else if (arrPreviousWords[1] === 'LOCATION' && bolIsPeriod) {
                        arrQueries = [['WITH']];
                    ...
                    } else if (strPreviousWord === 'LIKE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                        
                    } else if (arrPreviousWords[1] === 'LIKE' && bolIsPeriod) {
                        arrQueries = [['INCLUDING', 'EXCLUDING']];
                        
                    } else if ((strPreviousWord === 'INCLUDING' || strPreviousWord === 'EXCLUDING') && bolIsPeriod) {
                    ...
                    } else if ((arrPreviousWords[1] + strPreviousWord) === 'ONCOMMIT' && bolIsPeriod) {
                    ...
                    } else if (strPreviousWord === 'CONSTRAINT' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.constraint];
                        
                    } else if (strPreviousWord === 'REFERENCES' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    ...
                    } else if (strCurrentLine.trim().toUpperCase() === strPreviousWord && strPreviousWord !== strPreviousKeyWord && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                    }
                    ...
                    if (strPreviousWord === 'TRANSFORM' && bolIsPeriod) {
                        arrQueries = [['FOR']];
                    ...
                    } else if (strPreviousWord === 'FUNCTION' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    }
                    ...
                    } else if (strPreviousWord === 'PROCEDURE' && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.schemas];
                    }
                    ...
                    if (strPreviousWord === 'TYPE' && bolIsPeriod) {
                        ...
                        arrQueries = [['SUBTYPE =','SUBTYPE_OPCLASS =','COLLATION =','CANONICAL =','SUBTYPE_DIFF =']];
                                ...
                                strCurrentLine.trim().toUpperCase() === strPreviousWord && bolIsPeriod) {
                        arrQueries = [autocompleteQuery.types];
                    ...
                    if (arrPreviousWords[1] === 'USER' && !autocompleteSearchBackForWord(strScript, intCursorPosition, 'WITH') && bolIsPeriod) {
                        arrQueries = [['WITH']];
                    } else if (((/^(ROLE|GROUP|ADMIN|USER)$/gi).test(strPreviousWord) || bolAfterComma)
                                && autocompleteSearchBackForWord(strScript, intCursorPosition, 'WITH')) {
                        arrQueries = [autocompleteQuery.roles];
                    ...
                    } else if (arrPreviousWords[1] === 'VIEW' && bolIsPeriod) {
                        arrQueries = [['WITH']];
                    ...
                    if (arrPreviousWords[1] === 'DECLARE' && bolIsPeriod) {
                        arrQueries = [['BINARY', 'INSENSITIVE', 'SCROLL', 'NO SCROLL', 'CURSOR']];
                        
                    } else if (strPreviousWord === 'BINARY' && bolIsPeriod) {
                        arrQueries = [['INSENSITIVE', 'SCROLL', 'NO SCROLL', 'CURSOR']];
                        
                    } else if (strPreviousWord === 'INSENSITIVE' && bolIsPeriod) {
                        arrQueries = [['SCROLL', 'NO SCROLL', 'CURSOR']];
                        
                    } else if (strPreviousWord === 'SCROLL' && bolIsPeriod) {
                        arrQueries = [['CURSOR']];
                        
                    } else if (strPreviousWord === 'CURSOR' && bolIsPeriod) {
                        arrQueries = [['WITH HOLD', 'WITHOUT HOLD']];
                        
                    } else if ((/(WITH|WITHOUT|HOLD)/gi).test(strPreviousWord) && bolIsPeriod) {
                        arrQueries = [['FOR']];
                    }
                }
